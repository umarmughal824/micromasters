...
import { COUPON_CONTENT_TYPE_COURSE } from '../../constants';
...
describe("CouponMessage", () => {
  ...
  it('renders a message for a coupon for a course', () => {
    ...
    let makeAmountMessageStub = sandbox.stub(libCoupon, 'makeAmountMessage').returns('all of the money off');
  ...
  it('renders a message for a coupon for an unknown content type', () => {
    ...
    assert.equal(wrapper.text(), "You will get $50 off the cost.");
  });
});
