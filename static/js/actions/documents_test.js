...
describe('generated document action helpers', () => {
  it('should create all action creators', () => {
    [
      ...
      [receiveUpdateDocumentSentDateSuccess, RECEIVE_UPDATE_DOCUMENT_SENT_DATE_SUCCESS],
      [receiveUpdateDocumentSentDateFailure, RECEIVE_UPDATE_DOCUMENT_SENT_DATE_FAILURE],
