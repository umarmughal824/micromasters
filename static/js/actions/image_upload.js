...
export const RECEIVE_PATCH_USER_PHOTO_FAILURE = 'RECEIVE_PATCH_USER_PHOTO_FAILURE';
export const receivePatchUserPhotoFailure = createAction(RECEIVE_PATCH_USER_PHOTO_FAILURE);

export const RECEIVE_PATCH_USER_PHOTO_SUCCESS = 'RECEIVE_PATCH_USER_PHOTO_SUCCESS';
export const receivePatchUserPhotoSuccess = createAction(RECEIVE_PATCH_USER_PHOTO_SUCCESS);

export function updateUserPhoto(username: string, image: Blob, name: string): Dispatcher<string|void> {
