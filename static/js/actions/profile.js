...
const receiveGetUserProfileFailure = createAction(RECEIVE_GET_USER_PROFILE_FAILURE,
  (username, errorInfo) => ({ username, errorInfo })
);

export const CLEAR_PROFILE = 'CLEAR_PROFILE';
export const clearProfile = createAction(CLEAR_PROFILE, username => ({ username }));
...
export const startProfileEdit = createAction(START_PROFILE_EDIT, username => ({ username }));
...
const receivePatchUserProfileFailure = createAction(RECEIVE_PATCH_USER_PROFILE_FAILURE,
  (username, errorInfo) => ({ username, errorInfo })
);
...
export const updateProfileValidation = createAction(UPDATE_PROFILE_VALIDATION,
